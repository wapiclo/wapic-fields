  ...
  class WapicFieldMediaUploader {
    ...
    initImageUploader() {
      document.body.addEventListener("click", (e) => {
        ...
        frame.on("select", () => {
          ...
          const thumb = (attachment.sizes && attachment.sizes.thumbnail?.url) || attachment.icon || attachment.url || "";
    ...
    initRemoveImage() {
      document.body.addEventListener("click", (e) => {
        ...
        const button = preview.closest(".wcf-field")?.querySelector(".wcf-field-image-upload");
    ...
    initGalleryUploader() {
      document.body.addEventListener("click", (e) => {
        ...
        frame.on("select", () => {
          ...
          const existingIds = targetInput.value ? targetInput.value.split(",").filter(Boolean) : [];
          const newIds = [];
          ...
          selection.each((attachment) => {
            ...
            if (!existingIds.includes(id)) {
              ...
              wp.data.dispatch("core/notices").createNotice("warning", "Image ID " + id + " already exists", {
                type: "snackbar",
                isDismissible: true,
              });
            }
      ...
      document.body.addEventListener("click", (e) => {
        ...
        if (clearBtn) {
          ...
          if (input && preview) {
            ...
            const uploadBtn = clearBtn.closest(".wcf-gallery-actions")?.querySelector(".wcf-field-gallery-upload");
