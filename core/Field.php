...
class Field {
	...
	private function control_select2($required) {
		...
		// JavaScript: Inisialisasi Select2 + Trigger change agar tampil
		echo '<script>
    jQuery(document).ready(function($) {
        ...
        // PENTING: Trigger change agar Select2 render nilai yang sudah ada
