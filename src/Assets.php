...
class Assets {
	...
	public function enqueue_assets() {
		...
		// Always load media scripts if any media-related field is present
		if ($this->required_assets['media'] || $this->required_assets['editor']) {
			wp_enqueue_media();

			// Make sure media templates are loaded
			wp_enqueue_script('media-views');

			// Enqueue our media uploader script with proper dependencies
			wp_enqueue_script('wapic-field-media-upload', WAPIC_FIELDS_ASSETS . 'assets/js/media-upload.min.js', array('jquery', 'media-upload', 'media-views'), WAPIC_FIELDS_VERSION, true	);

			// Ensure media templates are printed
